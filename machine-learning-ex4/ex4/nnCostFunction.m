...
theta1_no_bias = (lambda/m) * Theta1(:, 2:end);
theta2_no_bias = (lambda/m) * Theta2(:, 2:end);

Theta1_grad = [ ((1/m) * delta1(:, 1)) ((1/m) * delta1(:, 2:end)) + theta1_no_bias ];
Theta2_grad = [ ((1/m) * delta2(:, 1)) ((1/m) * delta2(:, 2:end)) + theta2_no_bias ];
% -------------------------------------------------------------
